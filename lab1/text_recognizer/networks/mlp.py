...
from tensorflow.keras.layers import Input, Add, Activation, ZeroPadding2D, BatchNormalization, Conv2D, AveragePooling2D, MaxPooling2D, GlobalMaxPooling2D
...
def mlp(input_shape: Tuple[int, ...],
    ...
    model = resnet50.ResNet50(weights=None, pooling='max', classes=num_classes)
